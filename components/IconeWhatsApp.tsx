/**
 * O símbolo do WhatsApp (balão com o telefone dentro).
 *
 * Fica num componente só porque aparece em lugares com cores diferentes: no
 * checkout, branco sobre o verde do botão; no rodapé, no verde da marca sobre
 * fundo claro. Por isso a cor vem de fora, pelo `fill-current` — quem usa
 * escolhe com uma classe de texto.
 */
export default function IconeWhatsApp({
  className = "w-5 h-5",
}: {
  className?: string;
}) {
